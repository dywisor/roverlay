...
readonly WEBGUI_PRJROOT="${SCRIPT_DIR%/*}"
readonly PRJROOT="${WEBGUI_PRJROOT%/*}"
readonly REAL_SCRIPT="${SCRIPT_DIR}/scripts/${SCRIPT_NAME%.*}.sh"

export ROVERLAY_PRJROOT="${PRJROOT}"
export ROVERLAY_WEBGUI_PRJROOT="${WEBGUI_PRJROOT}"
export PYTHONPATH="${WEBGUI_PRJROOT}:${PRJROOT}${PYTHONPATH:+:}${PYTHONPATH}"
export X_RV_QUERY_CONFIG="${ROVERLAY_PRJROOT}/bin/query_config"

cd "${WEBGUI_PRJROOT}" || exit
